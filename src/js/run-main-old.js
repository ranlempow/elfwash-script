...
require(['jquery', 'underscore', 'backbone', 'js/luaw', 'power-assert', 'keycodes', 'jScrollPane', 'bootstrap', 'hiddenbar', 'require-css!css/basic', 'domReady!'], 
  ...
  window.RoomView = window.GroupView.extend({
    cmds: {
      bt_remvoe: {label:'移除'},
      bt_remvoe1: {label:'移除'},
      bt_remvoe2: {label:'移除'},
    ...
    initialize: function (name) {
      ...
      window.GroupView.prototype.initialize.apply(this);
    },
