...
require(['jquery', 'underscore', 'backbone', 'js/luaw', 'bootstrap', 'hiddenbar', 'require-css!css/basic', 'domReady!'], 
  ...
  window.MemberView = Backbone.View.extend({
    ...
    addItem: function (model, collection, options)  {
      ...
      $('ul', this.el).append($('<li class="member">').attr('cid', model.cid).text(title));
    },
  ...
  var L = Lua.lua_load(code)();
  //console.log(L.str.my_func(3));
  console.log(Lua.lua_tableget(L, "g"))
  Lua.lua_tablesetw(L, "obj", {a:1, b:2});
  Lua.lua_tablesetw(L, "arr2", [3,4,5]);
  Lua.lua_tablesetw(L, "print", function(msg) { console.log(msg); });
  Lua.lua_tablesetw(L, "newarray", function() { return []; });
  Lua.lua_tablesetw(L, "isarray", function() { return []; 'TODO'; });
